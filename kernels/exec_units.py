...
amd_insts_to_test = [
    ...
    EUTest(False, "s_mov", 100, 5,
        "int32_t sop1 = 0;\n",
        lambda i: "asm volatile(\"s_mov_b32 %0, %0\\n\":\"+s\"(sop1));\n",
        lambda n: "", 0, 0),

    EUTest(False, "s_add", 100, 5,
